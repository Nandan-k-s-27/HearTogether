 ...
 * Responds to mouse movement with fluid physics.
 */
...
export default function InteractiveWavesBackground({
  lineColor = 'black',
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 bg-brand-500/20 rounded-full w-2 h-2 pointer-events-none"
